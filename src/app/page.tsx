...
export default function Page() {
	return (
		<DocsLayout frontmatter={{ title: "YPP History, Mission, & Vision", description: "" }} nodes={[]}>
			<iframe className="w-[90%] m-auto aspect-video" src="https://player.vimeo.com/video/834908962?h=99a408a104" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>

			<details>
<summary>Video Transcript</summary>
<p className="max-w-3xl w-full mx-auto decoration-primary">
...
<p className="max-w-3xl w-full mx-auto decoration-primary/6">
...
<h1>What kind of math learning experiences do young people need in order to achieve full citizenship, a good career, and the best chance for a quality life in the 21st century?
</h1>
...
<p>
For more information, visit <a href="https://www.typp.org" target="_blank" >https://www.typp.org</a>.
</p>
		</DocsLayout>
	)
}